...
const checkBig = (n: number | bigint, min: bigint, max: bigint) => {
	if (typeof n === 'number') {
 ...
 * assertFalse(isUint16(0.5))
 * assertFalse(isUint16(NaN))
 * ```
 */
 ...
 * assertFalse(isUint64(NaN))
 * ```
 */
export const isUint64 = (n: number | bigint): boolean =>
	checkBig(n, 0n, 18_446_744_073_709_551_615n)
 ...
 * assertFalse(isUint128(NaN))
 * ```
 */
export const isUint128 = (n: number | bigint): boolean =>
	checkBig(n, 0n, 340_282_366_920_938_463_463_374_607_431_768_211_455n)
 ...
 * assertFalse(isInt64(NaN))
 * ```
 */
export const isInt64 = (n: number | bigint): boolean =>
	checkBig(n, -1n * 9_223_372_036_854_775_808n, 9_223_372_036_854_775_807n)

/**
 * Checks if the number is a 128-bit signed integer.
 *
 * If the given argument is of type `number`, it will be internally
 * changed to be a `bigint`.
 *
 * @example
 * ```ts
 * import { isInt128 } from '@nc/whatwg-infra/num'
 * import { assert, assertFalse } from '@std/assert'
 *
 * assert(isInt128(-1n * 170_141_183_460_469_231_731_687_303_715_884_105_728n))
 * assert(isInt128(170_141_183_460_469_231_731_687_303_715_884_105_727n))
 * assertFalse(isInt128(-1n * 170_141_183_460_469_231_731_687_303_715_884_105_729n))
 * assertFalse(isInt128(170_141_183_460_469_231_731_687_303_715_884_105_728n))
 * assertFalse(isInt128(0.5))
 * assertFalse(isInt128(NaN))
 * ```
 */
